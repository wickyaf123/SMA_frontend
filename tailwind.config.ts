  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "node-connector": "hsl(var(--node-connector))",
        "node-ingestion": "hsl(var(--node-ingestion))",
        "node-validation": "hsl(var(--node-validation))",
        "node-outreach": "hsl(var(--node-outreach))",
        "node-reply": "hsl(var(--node-reply))",
        "node-crm": "hsl(var(--node-crm))",
        sidebar: {
